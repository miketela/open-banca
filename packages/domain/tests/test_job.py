...
class TestJobEntity:
    ...
    def test_created_at_must_be_utc_aware(self) -> None:
        ...
        naive_dt = datetime(2024, 1, 1, 12, 0, 0)  # naive, no tzinfo
        # We accept either approach: validators may enforce UTC or just accept datetime.
        # The entity must at minimum accept UTC-aware datetimes.
        utc_job = Job(**_valid_job(created_at=datetime(2024, 1, 1, 12, 0, 0, tzinfo=timezone.utc)))
